...
public class InferenceInfoGraphic extends or.kr.ajouhosp.stroke.GraphicOverlay.Graphic {
  private static final int TEXT_COLOR = Color.WHITE;
  private static final float TEXT_SIZE = 60.0f;

  private final Paint textPaint;
  private final or.kr.ajouhosp.stroke.GraphicOverlay overlay;
  ...
  public InferenceInfoGraphic(
          or.kr.ajouhosp.stroke.GraphicOverlay overlay, double latency, @Nullable Integer framesPerSecond) {
    super(overlay);
